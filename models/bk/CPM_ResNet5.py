...
class pose_estimation(nn.Module):
    def __init__(self, class_num, pretrain=True):
        ...
        self.apply_fix()
        self.reduce_C4 = nn.Sequential(nn.Conv2d(1024, 256, 1, 1, 0))
        self.reduce_C5 = nn.Sequential(nn.Conv2d(2048, 256, 1, 1, 0))
    ...
    def forward(self, x):
        ...
        # C4 = F.upsample(C4, scale_factor=2)

        C5 = self.reduce_C5(C5)
        C5 = F.upsample(C5, scale_factor=4)
